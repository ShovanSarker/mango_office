...
from actions.views import login_page, login_auth, home, logout_now,\
    add_employee, change_status, employee_list, all_task, attendance, profile
admin.autodiscover()
...
urlpatterns = patterns('',
                       ...
                       url(r'^attendance/', view=attendance, name='home'),
